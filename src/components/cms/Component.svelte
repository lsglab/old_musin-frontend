...
<!--This each/else statement is as of the 4.7.2021 the onliest way to fix an error (Outros undefined)
...
{#each [...[]] as _}
	<div></div>
{:else}
	<svelte:component editing="{true}" this="{component.component}" bind:this="{rendered}" {...component.props}>
