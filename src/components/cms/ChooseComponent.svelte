<script>
	...
	import AboutSection from '../molecules/aboutSection.svelte';
	import BioCard from '../molecules/bioCard.svelte';
	import Card from '../atoms/Card.svelte';
	import EditComponent from '../../EditComponent';
	import Flex from '../atoms/Flex.svelte';
	import MensaCard from '../molecules/MensaCard.svelte';
	import SectionWrapper from '../molecules/sectionWrapper.svelte';
	import StaffCard from '../molecules/staffCard.svelte';
...
<div
	...
	<Flex
		justify="center"
		align="center"
		classes="w-full h-full text-center text-white rounded-full cursor-pointer bg-btnBlue">
		<svg
