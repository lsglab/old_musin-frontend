	...
	<div class = "card">
		<div class = "wrap-content">
			...
			{#if dev && error.stack || status == "404"}
				{#if status == "404"}
					<p>Günde dafür könnten sein, dass Sie eine falsche oder veraltete URL aufgerufen haben - bitte überprüfen Sie diese noch einmal. Oder aber wir haben die betreffende Seite archiviert, verschoben oder umbennant.</p>
			...
			{/if}
			<div class = "btn-wrap">
				<button on:click="{toStart}">Zur Startseite</button>
			</div>
		</div>
	</div>
</div>
