<script>
	import Index from '../components/templates/Index.svelte';
</script>
...
<Index
	...
	sectionHeader="Aktuelle Termine"
	sectionSubHeader="Alle demnächst anstehende Termine des Louise-Schroeder-Gymnasiums"
